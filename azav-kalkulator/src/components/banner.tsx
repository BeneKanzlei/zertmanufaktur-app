...
export default function Banner() {
  ...
  if (!isVisible) {
    console.log('Banner returning null')
    return null
  }
  ...
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      ...
      <p className="text-sm/6 text-gray-900">
        GeneriCon 2023 is on June 7 – 9 in Denver. <a href="#" className="font-semibold whitespace-nowrap text-gray-900 hover:text-gray-700">Get your ticket&nbsp;<span aria-hidden="true">&rarr;</span></a>
      </p>
      <div className="flex flex-1 justify-end">
        <button 
          type="button" 
          className="-m-3 p-3 focus-visible:-outline-offset-4 hover:bg-gray-100 rounded-md transition-colors"
          onClick={() => {
