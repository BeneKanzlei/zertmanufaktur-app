      ...
      <main className="pt-16">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Nutzungsbedingungen</h2>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">Die rechtlichen Bedingungen für die Nutzung unserer Zertmanufaktur-Plattform. Hier finden Sie alle wichtigen Informationen zu Ihren Rechten und Pflichten.</p>
          </div>
        </div>
      </main>
